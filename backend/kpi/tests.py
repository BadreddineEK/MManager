...
class TestKPIMosqueList(TenantTestCase):
    """Tests du endpoint GET /api/kpi/mosques/."""

    def setUp(self):
        self.client = APIClient()
        Mosque.objects.create(
            schema_name="alpha",name="Mosquée Alpha", slug="alpha", timezone="Europe/Paris")
        Mosque.objects.create(
            schema_name="beta",name="Mosquée Beta", slug="beta", timezone="Europe/Paris")
...
class TestKPISummary(TenantTestCase):
    ...
    def test_other_mosque_sees_zero_data(self):
        ...
        Mosque.objects.create(
            schema_name="vide",name="Vide", slug="vide", timezone="Europe/Paris")
